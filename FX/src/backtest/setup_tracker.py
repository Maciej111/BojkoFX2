...
class SetupTracker:
    ...
    def create_setup(self, direction, bos_level, bos_time, entry_price, expiry_time, expiry_bar_count, htf_bias, ltf_pivot_type):
        ...
        self.active_setup = PullbackSetup(direction, bos_level, bos_time, entry_price, expiry_time, expiry_bar_count, htf_bias, ltf_pivot_type)
